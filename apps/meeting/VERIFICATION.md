...
- No new real GPT-Live session or production deployment was performed for this extension. A new test room is recommended after deployment to pick up default file permissions and updated Chat instructions. Real spoken requests, model-chosen tool sequences, complex uploads, and longer meetings remain deployment-environment checks.
