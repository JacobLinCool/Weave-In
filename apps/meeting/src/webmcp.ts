...
/**
 * WebMCP exposes meeting, screen capture, shared whiteboard and private reminder tools
 * to an agent in the participant's browser. Results come from this browser's own copy
 * of the room; private reminders stay local to the participant.
 */
