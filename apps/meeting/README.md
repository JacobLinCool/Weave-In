...
3. In **Muse → Settings**, confirm **Allow posting to Room (visible to everyone)** is unchecked. If you change it, choose **Save settings**; otherwise choose **Back to Muse**. Select **Talk to Muse** and ask, “Use our discussion and the uploaded reference to draw the workflow on the whiteboard. Keep your reply private.”
